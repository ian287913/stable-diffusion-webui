...
TEXT2IMAGE_PARAMETERS = {
    ...
    'prompt_species' : ['regal blue tang', 'bowfin fish', 'koi', 'queen angelfish', 'striped bass', 'croaker', 'tuna'],
    ...
    'negative_prompt' : "((disfigured)) ((extra eyes)) ((duplicate)) ((culled)) (((out of frame))) (((deformed))) ((bad anatomy)) ((without head))",

    'cfg_scale' : [11],
    'denoising_strength' : [0.80, 0.85],
    'steps' : [100],
